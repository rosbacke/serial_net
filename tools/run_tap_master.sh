...
sudo ${HOME}/0_project/serial_net-build/src/mains/serialnet/serialnet --mode tap -m -l 2 --address 1 --wsdump ${HOME}/packet.txt -d /dev/ttyUSB0 --serial-options pulldown
